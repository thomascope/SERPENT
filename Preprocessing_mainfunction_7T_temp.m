...
<<<<<<< HEAD
        cmd = ['recon-all -all -notal-check -s freesurfer_output_2 -hires -i ' pathstem blocksout{subjcnt}{find(strcmp(blocksout{subjcnt},'structural'))} '.nii -expert ' scriptdir 'expert_hires.opts'];
=======
...
>>>>>>> 74b443cf3e34af5820c587770d8a9a9e59ab0259
