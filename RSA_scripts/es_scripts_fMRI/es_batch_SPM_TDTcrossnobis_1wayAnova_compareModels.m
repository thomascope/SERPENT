...
version = 'spearmanFromSimByFea';

GLMAnalPD = '/imaging/es03/fMRI_2017/GLMAnalysisNative';
OutputPD = [GLMAnalPD '/TDTcrossnobis_' version '/SPMs/Anova_Masked_CompareModelsSyl2'];
...
con2analyse = {'SensorySyl2' 'PredSyl2' 'PEabsSyl2' 'SsSyl2'};
...
contrasts{cnt}.name = 'Main effect factor 1';
