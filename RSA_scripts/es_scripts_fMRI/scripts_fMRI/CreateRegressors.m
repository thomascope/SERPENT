...
for sess=1:NumSess
    ...
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'clearSpeech')==1 & tmp{:,18}==2 & tmp{:,20}==1 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Strong+M';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
    
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'clearSpeech')==1 & tmp{:,18}==1 & tmp{:,20}==1 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Weak+M';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
    
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'clearSpeech')==1 & tmp{:,18}==2 & tmp{:,20}==2 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Strong+MM';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
    
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'clearSpeech')==1 & tmp{:,18}==1 & tmp{:,20}==2 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Weak+MM';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
    
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'noiseFinal')==1 & tmp{:,18}==2 & tmp{:,20}==1 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Strong+Noise';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
    
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'noiseFinal')==1 & tmp{:,18}==1 & tmp{:,20}==1 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Weak+Noise';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
    
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'noiseInitial')==1 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Noise+Speech';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
    
    counter = counter + 1;
    conIdx{counter} = find( ismember(tmp{:,21},'noiseBoth')==1 & tmp{:,5}==0 ); % Non-targets
    names{counter} = 'Noise+Noise';
    onsets{counter} = double(tmp{6}(conIdx{counter}));
    durations{counter} = zeros(length(onsets{counter}),1);
