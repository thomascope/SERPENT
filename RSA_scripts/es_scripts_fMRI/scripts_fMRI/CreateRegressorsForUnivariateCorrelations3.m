...
for sess=1:NumSess
    ...
    tmp2 = textscan(fid2,'%s%s%s%s%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f%f','Delimiter','\t','HeaderLines',0);
    ...
    fclose(fid2);
%     load('/group/language/data/ediz.sohoglu/projects/fMRI_2017/scripts_fMRI/PredictorsFromSimSegLocalVersion/predictor_sim_univariate_pred_syl1.mat','predictorForfMRI');
...
%     X(:,1) = predictorForfMRI;
    load('/group/language/data/ediz.sohoglu/projects/fMRI_2017/scripts_fMRI/PredictorsFromSimSegLocalVersion/predictor_sim_univariate_pred_syl2seg2.mat','predictorForfMRI');
    predictorForfMRI(predictorForfMRI==0) = 1e-3;
    predictorForfMRI = -log(predictorForfMRI);
    predictorForfMRI = zscore(predictorForfMRI);
    X(:,1) = predictorForfMRI;
