...
toolboxRoot = '/group/language/data/ediz.sohoglu/matlab/rsatoolbox'; addpath(genpath(toolboxRoot)); % Catch sight of the toolbox code
userOptions = defineUserOptions({'subj10'});
