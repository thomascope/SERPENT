...
RsaAnalPD = '/imaging/es03/fMRI_2017/GLMAnalysisNative/RSA_parametric_NaNforCrossSplice';
OutputPD = [RsaAnalPD '/SPMs/Anova_2x2_Syl2_Masked'];
...
models = {'Syl2StrongM' 'Syl2WeakM' 'Syl2StrongMM' 'Syl2WeakMM'};
%models = {'Syl2GradedStrongM' 'Syl2GradedWeakM' 'Syl2GradedStrongMM' 'Syl2GradedWeakMM'};
