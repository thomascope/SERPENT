...
OutputPD = [GLMAnalPD '/TDTcrossnobis_' version '/SPMs/Anova_Masked_2x2Graded_SignalXStrength'];
...
con2analyse = {'Syl2GradedWeakNoise' 'Syl2GradedWeakM' 'Syl2GradedStrongNoise' 'Syl2GradedStrongM'};
...
contrasts{cnt}.name = 'Main effect of signal quality';
cnt = cnt+1;
contrasts{cnt}.type = 'F';
...
contrasts{cnt}.name = 'Signal quality X prior strength';
