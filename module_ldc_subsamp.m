% Modified by TEC 17/5/18 to allow subsampling with a roi mask from Johan's original pilab 
%
...
function [disvol,permres,splitdisvolcell,sesspermres] = module_ldc_subsamp(rois,designvol,epivol,varargin)
