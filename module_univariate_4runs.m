...
jobfile = {'/group/language/data/thomascope/7T_full_paradigm_pilot_analysis_scripts/module_univariate_4runs_job.m'};
...
for crun = 1:nrun
    ...
    inputs{32, crun} = MATLAB_CODE_TO_FILL_INPUT; % fMRI model specification: Scans - cfg_files
    ...
    inputs{41, crun} = MATLAB_CODE_TO_FILL_INPUT; % fMRI model specification: Multiple regressors - cfg_files
end
spm('defaults', 'FMRI');
