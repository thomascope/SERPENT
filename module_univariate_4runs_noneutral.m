...
jobfile = {'/group/language/data/thomascope/7T_full_paradigm_pilot_analysis_scripts/module_univariate_4runs_noneutral_job.m'};
...
for crun = 1:nrun
    ...
    inputs{26, crun} = MATLAB_CODE_TO_FILL_INPUT; % fMRI model specification: Scans - cfg_files
    ...
    inputs{33, crun} = MATLAB_CODE_TO_FILL_INPUT; % fMRI model specification: Multiple regressors - cfg_files
end
spm('defaults', 'FMRI');
