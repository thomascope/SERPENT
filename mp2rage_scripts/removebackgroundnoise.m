function denoised=removebackgroundnoise(uni,inv1,inv2)
% removebackgroundnoise(uni,inv1,inv2)
% This function implements the regularization proposed in:
%
% O’Brien, et al, 2014. 
...
MP2RAGE.filenameINV1=inv1;% Inversion Time 1 MP2RAGE T1w image;
MP2RAGE.filenameINV2=inv2;% Inversion Time 2 MP2RAGE T1w image;

[apath,afile,anext]=fileparts(uni);
MP2RAGE.filenameOUT=fullfile(apath,strcat(afile,'_denoised',anext));% image without background noise;
