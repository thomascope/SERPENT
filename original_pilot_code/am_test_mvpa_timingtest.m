...
if ~(exist(['tpatterns_masked_t2_' subj_initials '.mat'],'file'))
...
if ~(exist(['tpatterns_masked_t2_' subj_initials '.mat'],'file'))
    % save the t-patterns
    save(['tpatterns_masked_t2_' subj_initials '.mat'], 'tpatterns','wholebrain_tpatterns')
else
    % if the t-patterns already exist --> load it
    %load('tpatterns.mat')
    load(['tpatterns_masked_t2_' subj_initials '.mat'])
end
