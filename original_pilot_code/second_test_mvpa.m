...
if analyse.searchlight
    ...
    addpath('/imaging/tc02/7T_full_paradigm_pilot/Preprocessed_Images')
    for condJ = 1:nTrialtypes
        %Define matrix based on shared features
        ...
        userOptions.betaPath = '/imaging/tc02/7T_full_paradigm_pilot/Preprocessed_Images/WRBJ_univariate/beta_[[betaIdentifier]].nii';
        %userOptions.subjectNames = {subj_initials};
        userOptions.analysisName = ['Condition_' num2str(condJ)];
        userOptions.rootPath = '/imaging/tc02/7T_full_paradigm_pilot/Preprocessed_Images/Searchlight';
