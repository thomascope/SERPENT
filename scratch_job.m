%-----------------------------------------------------------------------
% Job saved on 27-Jul-2021 10:11:50 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.registration.regmethod.shooting.shootingtpm = {'/group/language/data/thomascope/spm12_fil_r6906/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
...
matlabbatch{2}.spm.tools.cat.estwrite.nproc = 28;
matlabbatch{2}.spm.tools.cat.estwrite.useprior = '';
matlabbatch{2}.spm.tools.cat.estwrite.opts.tpm = {'/group/language/data/thomascope/spm12_fil_r6906/tpm/TPM.nii'};
matlabbatch{2}.spm.tools.cat.estwrite.opts.affreg = 'mni';
matlabbatch{2}.spm.tools.cat.estwrite.opts.biasstr = 1;
matlabbatch{2}.spm.tools.cat.estwrite.opts.accstr = 0.5;
matlabbatch{2}.spm.tools.cat.estwrite.extopts.segmentation.restypes.optimal = [1 0.3];
matlabbatch{2}.spm.tools.cat.estwrite.extopts.segmentation.setCOM = 1;
matlabbatch{2}.spm.tools.cat.estwrite.extopts.segmentation.APP = 1070;
matlabbatch{2}.spm.tools.cat.estwrite.extopts.segmentation.affmod = 0;
...
matlabbatch{2}.spm.tools.cat.estwrite.extopts.segmentation.LASmyostr = 0;
...
matlabbatch{2}.spm.tools.cat.estwrite.extopts.segmentation.WMHC = 2;
...
matlabbatch{2}.spm.tools.cat.estwrite.extopts.registration.regmethod.shooting.shootingtpm = {'/group/language/data/thomascope/spm12_fil_r6906/toolbox/cat12/templates_MNI152NLin2009cAsym/Template_0_GS.nii'};
matlabbatch{2}.spm.tools.cat.estwrite.extopts.registration.regmethod.shooting.regstr = 0.5;
matlabbatch{2}.spm.tools.cat.estwrite.extopts.registration.vox = 1.5;
matlabbatch{2}.spm.tools.cat.estwrite.extopts.registration.bb = 12;
...
matlabbatch{2}.spm.tools.cat.estwrite.extopts.surface.SRP = 22;
matlabbatch{2}.spm.tools.cat.estwrite.extopts.surface.reduce_mesh = 1;
matlabbatch{2}.spm.tools.cat.estwrite.extopts.surface.vdist = 2;
...
matlabbatch{2}.spm.tools.cat.estwrite.output.BIDS.BIDSno = 1;
...
matlabbatch{2}.spm.tools.cat.estwrite.output.ROImenu.atlases.thalamus = 0;
...
matlabbatch{2}.spm.tools.cat.estwrite.output.ROImenu.atlases.anatomy3 = 0;
...
matlabbatch{2}.spm.tools.cat.estwrite.output.TPMC.warped = 0;
...
matlabbatch{2}.spm.tools.cat.estwrite.output.jacobianwarped = 0;
matlabbatch{2}.spm.tools.cat.estwrite.output.warps = [1 0];
matlabbatch{2}.spm.tools.cat.estwrite.output.rmat = 0;
