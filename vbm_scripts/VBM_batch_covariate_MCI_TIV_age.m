%-----------------------------------------------------------------------
% Job saved on 05-Nov-2018 11:51:52 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
%-----------------------------------------------------------------------
...
matlabbatch{1}.spm.stats.factorial_design.des.anova.icell(5).scans = '<UNDEFINED>';
...
matlabbatch{1}.spm.stats.factorial_design.cov(3).cname = 'Connectivity';
