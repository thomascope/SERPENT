...
for i = 1:length(scan_paths)
    oldfilenames{i}= cellstr([split_stem{i}{1} '/mprage_125/wc1' split_stem{i}{2}]);
    newfilenames{i}= cellstr([split_stem{i}{1} '/mprage_125/s_0_wc1' split_stem{i}{2}]);
    try
...
newfilenames = cell(length(scan_paths),1);
for i = 1:length(scan_paths)
    oldfilenames{i}= cellstr([split_stem{i}{1} '/mprage_125/swc1' split_stem{i}{2}]);
    newfilenames{i}= cellstr([split_stem{i}{1} '/mprage_125/s_8_wc1' split_stem{i}{2}]);
    try
        movefile(char(oldfilenames{i}),char(newfilenames{i}));
    catch
    end
