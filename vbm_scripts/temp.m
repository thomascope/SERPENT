...
jobfile = {'/imaging/tc02/vespa/scans/PNFA_VBM/tom/temp_job.m'};
...
for crun = 1:nrun
    ...
    inputs{7, crun} = MATLAB_CODE_TO_FILL_INPUT; % Factorial design specification: Explicit Mask - cfg_files
end
spm('defaults', 'PET');
